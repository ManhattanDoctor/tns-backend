...
import { CompanyLedgerNotFoundError, CompanyRoleInvalidError, CompanyRoleUndefinedError, CompanyStatusInvalidError, CompanyUndefinedError, UserStatusInvalidError, UserTypeInvalidError, UserUndefinedError } from '@project/module/core/middleware';
...
export class UserGuard extends AuthGuard('jwt') {
    ...
    public static checkCoin(options: IGuardOptions, company: CompanyEntity): void {
        if (!options.isCompanyRequired) {
            return;
        }
        if (options.isCompanyRequired && _.isNil(company)) {
