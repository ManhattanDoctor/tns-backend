...
export class CoinEmitted extends EventParser<ICoinEmitDto, void, void> {
    // --------------------------------------------------------------------------
    //
    //  Protected Methods
    //
    ...
    protected async execute(): Promise<void> {
        ...
        this.action(ActionType.COIN_EMITTED_SENT, this.data.coinUid, details);
        this.action(ActionType.COIN_EMITTED_RECEIVE, this.data.objectUid, details);
